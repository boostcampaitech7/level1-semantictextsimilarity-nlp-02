...
if __name__ == '__main__':
    ...
    config = load_config('configs/deberta_base_80.yaml')
    ...
    # Inference part
    # 저장된 모델로 예측을 진행합니다.
    model = torch.load('saves/'+config['model_nick'])
    checkpoint = torch.load('saves/models/deberta-large-epoch=07-val_pearson=0.937-max120.ckpt')
